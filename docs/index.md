...
<img src='{{ '/assets/images/option2_6_download.PNG' | relative_url }}' alt='Screenshot showing the locations of the Download button and the .zip file which is ready to be downloaded.' title='' width='466' height='276' />
 ...
 [Downloading\_Census\_Boundary\_Files\_Using\_ScholarsGeoPortal.pdf](/sites/default/public/Downloading_Census_Boundary_Files_Using_ScholarsGeoPortal.pdf)Technique: [Searching for maps and data](/technique/searching-maps-and-data) \| Data Format: [Vector](/data-format/vector)**Date Created:** 2016\-07\-26**Updated:** 2024\-07\-25
